-- 创建库
create database if not exists xl_api;

-- 切换库
use xl_api;

-- 用户表
create table if not exists xl_api.user
(
...
-- 每日签到表
create table if not exists xl_api.daily_check_in
(
    id          bigint auto_increment comment 'id' primary key,
...
-- 接口信息
create table if not exists xl_api.interface_info
(
    id             bigint auto_increment comment 'id' primary key,
...
-- 产品信息
create table if not exists xl_api.product_info
(
    id             bigint auto_increment comment 'id' primary key,
...
# 产品订单
create table if not exists xl_api.product_order
(
    id             bigint auto_increment comment 'id' primary key,
...
#付款信息
create table if not exists xl_api.payment_info
(
    id             bigint auto_increment comment 'id' primary key,
...
-- 用户接口调用表
create table if not exists xl_api.user_interface_invoke
(
    id           bigint auto_increment comment 'id' primary key,
...
-- 充值活动表
create table if not exists xl_api.recharge_activity
(
    id         bigint auto_increment comment 'id' primary key,
...
INSERT INTO xl_api.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime, createTime, updateTime, isDelete) VALUES (1695338876708544514, '100坤币', '增加100坤币到钱包', 1691069533871013889, 1, 100, 'RECHARGEACTIVITY', 1, null, '2023-08-26 15:34:20', '2023-08-28 12:58:30', 0);
INSERT INTO xl_api.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime, createTime, updateTime, isDelete) VALUES (1695773972037839073, '9999坤币', '增加9999坤币到钱包', 1691069533871013889, 699, 9999, 'RECHARGE', 1, '2023-08-28 13:01:34', '2023-08-27 20:35:34', '2023-08-27 20:41:29', 0);
INSERT INTO xl_api.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime, createTime, updateTime, isDelete) VALUES (1695776766919888897, '1000坤币', '增加1000坤币到钱包', 1691069533871013889, 99, 1000, 'RECHARGE', 1, null, '2023-08-27 20:34:21', '2023-08-27 20:34:21', 0);
INSERT INTO xl_api.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime, createTime, updateTime, isDelete) VALUES (1695777072030339073, '3000坤币', '增加3000坤币到钱包', 1691069533871013889, 199, 3000, 'RECHARGE', 1, null, '2023-08-27 20:35:34', '2023-08-27 20:41:29', 0);
INSERT INTO xl_api.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime, createTime, updateTime, isDelete) VALUES (1695777203236556802, '15999坤币', '增加15999坤币到钱包', 1691069533871013889, 888, 15999, 'RECHARGE', 1, null, '2023-08-27 20:36:05', '2023-08-28 13:02:25', 0);
INSERT INTO xl_api.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime, createTime, updateTime, isDelete) VALUES (1695778320091631617, '18999坤币', '增加18999坤币到钱包', 1691069533871013889, 999, 18999, 'RECHARGE', 1, null, '2023-08-27 20:40:32', '2023-08-28 13:02:42', 0);
INSERT INTO xl_api.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime, createTime, updateTime, isDelete) VALUES (1697087470134259713, '10坤币', '签到获取', 1692848556158709762, 0, 10, 'RECHARGE', 0, null, '2023-08-31 11:22:37', '2023-08-31 11:22:37', 1);

insert into xl_api.interface_info(`id`, `name`, `url`, `userId`, `method`, `requestParams`, `reduceScore`, `requestExample`,
...
values (1705234447153963010, '随机毒鸡汤', 'http://127.0.0.1:8090/api/poisonousChickenSoup', 1698354419367571457, 'GET',
        NULL, 1, 'http://127.0.0.1:8090/api/poisonousChickenSoup', NULL, NULL, '随机毒鸡汤', 1, 228, '', 'JSON',
       ...
       (1705237104270712833, '获取输入的名称', 'http://127.0.0.1:8090/api/name', 1698354419367571457, 'GET',
        '[{\"id\":\"1695031845159\",\"fieldName\":\"name\",\"type\":\"string\",\"desc\":\"输入的名称\",\"required\":\"是\"}]',
        1, 'http://127.0.0.1:8090/api/name?name=zhangshan', NULL, NULL, '获取输入的名称', 1, 36,
       ...
       (1705237990061580289, '随机壁纸', 'http://127.0.0.1:8090/api/randomWallpaper', 1698354419367571457, 'GET',
        ...
        1, 'http://127.0.0.1:8090/api/randomWallpaper?lx=dongman', NULL, NULL, '获取随机壁纸', 1, 97,
       ...
       (1705238841173942274, '每日星座运势', 'http://127.0.0.1:8090/api/horoscope', 1698354419367571457, 'GET',
        ...
        1, 'http://127.0.0.1:8090/api/horoscope?type=scorpio&time=nextday', NULL, NULL, '获取每日星座运势', 1, 23,
       ...
       (1705239469589733378, '随机土味情话', 'http://127.0.0.1:8090/api/loveTalk', 1698354419367571457, 'GET', NULL, 1,
        'http://127.0.0.1:8090/api/loveTalk', NULL, NULL, '获取土味情话', 1, 413,
       ...
       (1705239928861827073, '获取IP信息归属地', 'http://127.0.0.1:8090/api/ipInfo', 1698354419367571457, 'GET',
        '[{\"id\":\"1695388304868\",\"fieldName\":\"ip\",\"type\":\"string\",\"desc\":\"输入IP地址\",\"required\":\"是\"}]',
        1, 'http://127.0.0.1:8090/api/ipInfo?ip=58.154.0.0', NULL, NULL, '获取IP信息归属地详细版', 1, 59,
       ...
       (1705240565347459073, '获取天气信息', 'http://127.0.0.1:8090/api/weather', 1698354419367571457, 'GET',
        ...
        1, 'http://127.0.0.1:8090/api/weather?ip=180.149.130.16', NULL, NULL, '获取每日每周的天气信息', 1, 109,
