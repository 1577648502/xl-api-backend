...
import com.lfg.xlapibackend.config.AliPayAccountConfig;
import com.lfg.xlapibackend.config.EmailConfig;
import com.lfg.xlapibackend.mapper.ProductOrderMapper;
import com.lfg.xlapibackend.model.alipay.AliPayAsyncResponse;
...
import com.lfg.xlapibackend.model.enums.AlipayTradeStatusEnum;
...
import com.lfg.xlapibackend.utils.EmailUtil;
...
import static com.lfg.xlapibackend.constant.PayConstant.*;
import static com.lfg.xlapibackend.model.enums.PayTypeStatusEnum.ALIPAY;
import static com.lfg.xlapibackend.model.enums.PaymentStatusEnum.*;
...
public class AlipayOrderServiceImpl extends ServiceImpl<ProductOrderMapper, ProductOrder> implements ProductOrderService {
    ...
    public void processingTimedOutOrders(ProductOrder productOrder) {
        ...
        try {
            ...
            System.out.println(alipayTradeQueryResponse.getCode());
    ...
    public void sendSuccessEmail(ProductOrder productOrder, String orderTotal) {
        // 发送邮件
