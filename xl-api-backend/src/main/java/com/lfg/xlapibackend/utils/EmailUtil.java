package com.lfg.xlapibackend.utils;

import com.lfg.xlapibackend.config.EmailConfig;
import com.lfg.xlapibackend.constant.EmailConstant;
...
public class EmailUtil {
    ...
    public static String buildEmailContent(String emailHtmlPath, String captcha) {
        ...
        // 替换html模板中的参数
        return MessageFormat.format(buffer.toString(), captcha, EmailConstant.EMAIL_TITLE);
    }
    ...
    public static String buildPaySuccessEmailContent(String emailHtmlPath, String orderName, String orderTotal) {
        ...
        // 替换html模板中的参数
        return MessageFormat.format(buffer.toString(), orderName, orderTotal, EmailConstant.EMAIL_TITLE);
    }
