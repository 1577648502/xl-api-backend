package com.lfg.xlapibackend.service.alipay;
...
import com.lfg.xlapibackend.service.impl.AlipayOrderServiceImpl;
...
import static com.lfg.xlapibackend.constant.PayConstant.RESPONSE_CODE_SUCCESS;
import static com.lfg.xlapibackend.model.enums.PaymentStatusEnum.NOTPAY;
...
public class AliPayTest {
    ...
    String OutTradeNo = "order_70071590808049085446";
    @Resource
    @Qualifier("ALIPAY")
    ...
    void sendSuccessEmail(){
        ...
        productOrder.setUserId(1711567944026345474L);
        alipayOrderService.sendSuccessEmail(productOrder,"123456");
    }
    @SneakyThrows
    @Test
    ...
    void alipayCreateOrder() {
        ...
        System.out.println(alipay_request.getNotifyUrl());
